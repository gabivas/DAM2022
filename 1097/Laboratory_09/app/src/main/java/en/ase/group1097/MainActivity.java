...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            OutputStreamWriter outputStreamWriter =
                    new OutputStreamWriter(getApplicationContext()
    ...
    private String citireTextDinFisier(Context context, String numeFisier) {
        String textCitit="";
        try {
            InputStream is = context.openFileInput(numeFisier);
